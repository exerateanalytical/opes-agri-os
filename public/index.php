 ...
 * `~/opesagrios`. Detecting that here means the copy needs no hand-editing — the
...
if ($root === null) {
    ...
    exit('OPES AGRI OS could not find its application files. They belong either in the parent '
        .'directory of this one, or in a folder named "opesagrios" beside it.');
}
