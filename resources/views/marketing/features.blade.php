...
<x-layouts.marketing title="Features"
                     description="Every module in Opes Agri OS: sales and invoicing, verified documents, SYSCOHADA accounting, forms, events and offline mode.">

<x-marketing.page-header eyebrow="Features" title="Every module, in one suite"
    lead="Opes Agri OS covers the whole business day — from a quotation to a paid, verified receipt — without switching apps or paying for an add-on." />
