<x-layouts.marketing title="About"
                     description="Opes Agri OS is built by Opesware Technologies for small and growing businesses in Cameroon that need sales, invoicing and records in one place — including when the connection fails.">

<x-marketing.page-header eyebrow="About" title="Built here, for how business is actually done here"
    :lead="'Opes Agri OS is a product of '.config('opes.brand.vendor').', for small and growing businesses that need sales, invoicing and customer records in one place — including in the moments the connection does not cooperate.'" />
