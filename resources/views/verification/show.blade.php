@php
    ...
    [$tone, $icon, $headline, $line] = match ($verdict) {
        'valid' => ['positive', 'check-circle', 'Verified authentic', 'This record was issued through OPES AGRI OS and has not been altered.'],
        ...
        default => ['warning', 'alert', 'Unknown code', 'This code does not match any record issued through OPES AGRI OS.'],
    };
