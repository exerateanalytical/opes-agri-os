...
class AbilityEnforcementTest extends TestCase
{
    ...
    protected function endpoints(): array
    {
        return [
            ...
            ['method' => 'GET', 'uri' => "/api/v1/fields/{$this->field->id}/soil-tests"],
            ['method' => 'POST', 'uri' => "/api/v1/fields/{$this->field->id}/soil-tests"],
            ['method' => 'GET', 'uri' => "/api/v1/fields/{$this->field->id}/irrigation-logs"],
            ['method' => 'POST', 'uri' => "/api/v1/fields/{$this->field->id}/irrigation-logs"],
