...
return [
     ...
     */
    // Only the public v1 API — not the legacy `api/sync/v1/*` protocol
    // (SyncController), which is an internal offline-sync detail, not a
    // product surface for partners/integrators to read docs for.
    'api_path' => [
        'include' => 'api/v1',
    ],
    ...
    'info' => [
         ...
         */
        'description' => 'The OPES AGRI OS API — token-authenticated, one company per token. '
            .'Create an API key from Company Settings → API Keys, then use it as a Bearer token below.',
    ],

    'ui' => [
        'title' => 'OPES AGRI OS API',
    ],
