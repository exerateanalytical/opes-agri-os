...
return [
    ...
    'brand' => [
        'name' => 'OPES AGRI OS',
        // The wordmark is two-toned: "OPES" in ink, "AGRI OS" in brand blue.
        'name_prefix' => 'OPES',
        'name_suffix' => 'AGRI OS',
    ...
    'demo' => [
        ...
        'admin_email' => 'admin@opesagrios.com',
    ],
    ...
    'navigation' => [
        ...
        ['key' => 'trace', 'label' => 'Trace a batch', 'icon' => 'cube', 'route' => 'products.trace', 'ability' => 'products.view'],
     ...
     */
    'contact' => [
        'recipient' => env('CONTACT_RECIPIENT', env('MAIL_FROM_ADDRESS', 'support@opesagrios.com')),
        'support_email' => '360@opesagrios.com',
