...
class Permissions
{
    ...
    public const CATALOGUE = [
        ...
        // Still no create/update/delete — the dashboard writes nothing — but
        // `export` joined `view` once CSV export shipped, the same
        // view/export split Reports uses: walking out with the numbers as a
        // file is a different right than reading them on screen. It reads
        // across modules a role might not otherwise have `view` on
        // individually, which is why it is its own group rather than folded
        // into Reports (see docs/architecture/agri-platform-roadmap.md, V4
        // Phase 5).
