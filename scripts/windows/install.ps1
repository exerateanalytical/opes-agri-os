<#
.SYNOPSIS
    Sets up OPES AGRI OS on this Windows machine at https://opesagrios.test
...
.EXAMPLE
    .\install.ps1
    .\install.ps1 -DbPassword "secret" -Domain opesagrios.test
#>

[CmdletBinding()]
param(
    [string] $Domain     = 'opesagrios.test',
    [string] $DbName     = 'opesagrios',
    [string] $DbUser     = 'root',
    [string] $DbPassword = '',
    [int]    $PhpPort    = 9001,
    [switch] $SkipSeed
...
Write-Host "OPES AGRI OS - local setup at https://$Domain" -ForegroundColor White
