#!/usr/bin/env bash
#
# Brings the local https://opesagrios.test deployment back up.
#
...
until curl -s --noproxy opesagrios.test -o /dev/null https://opesagrios.test/up; do sleep 1; done

echo
echo "  https://opesagrios.test   ready"
